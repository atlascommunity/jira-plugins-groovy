...
public class FieldConfigWithTemplateCrudIT {
    @Inject
    @ComponentImport
    ...
    public void beforeEach() throws GenericEntityException {
        field = customFieldHelper.createTemplateField();
    }
    ...
    private FieldConfigForm createScriptForm() {
        ...
        form.setScriptBody("//");
        form.setVelocityParamsEnabled(true);
        form.setTemplate("$value");
        return form;
    }
    ...
    public void shouldCreateScript() {
        ...
        changeLogHelper.assertChangeLogCreatedWithTemplate(script.getFieldScriptId());
    }
