define('mailru/groovy/i18n-react', [], function() {
    ...
    return {
        ...
        common: {
            ...
            log: AJS.I18n.getText('ru.mail.jira.plugins.groovy.common.log'),
            result: AJS.I18n.getText('ru.mail.jira.plugins.groovy.common.result')
        },
        error: {
        ...
        adminScript: {
            ...
            modifyAndRun: AJS.I18n.getText('ru.mail.jira.plugins.groovy.adminScripts.modifyAndRun')
        }
    };
});
