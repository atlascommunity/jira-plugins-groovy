...
export const entityTypes = [
    'REGISTRY_SCRIPT', 'REGISTRY_DIRECTORY', 'LISTENER', 'REST', 'CUSTOM_FIELD', 'SCHEDULED_TASK', 'ADMIN_SCRIPT', 'JQL_FUNCTION'
];

export type EntityType = 'REGISTRY_SCRIPT' | 'REGISTRY_DIRECTORY' | 'LISTENER' | 'REST' | 'CUSTOM_FIELD' | 'SCHEDULED_TASK' | 'ADMIN_SCRIPT' | 'JQL_FUNCTION';
